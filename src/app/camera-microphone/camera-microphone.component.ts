...
// Component used for recording video and audio from the user's camera and microphone
@Component({
...
export class CameraMicrophoneComponent implements OnInit {
  ...
  // ViewChilds for recording & displying video elements
  ...
  // OnInit method to load the video from IndexedDB by calling loadVideo on component initialization
  ngOnInit(): void {
    this.loadVideo();
  }
