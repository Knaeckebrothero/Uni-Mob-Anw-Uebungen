...
@Component({
  selector: 'app-uebung-3-location',
  templateUrl: './uebung-3-location.component.html',
  styleUrls: ['./uebung-3-location.component.scss']
})
export class Uebung3LocationComponent implements OnInit, OnDestroy {
